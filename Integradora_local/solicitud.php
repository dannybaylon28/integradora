...
<head>
    <meta charset="UTF-8">
    <title>LBC Suppliers - Realizar pedido</title>
    ...
    <style>
            ...
            max-width: 600px;
            width: 100%;
            margin: 50px auto; /* Centrar el formulario y separarlo de la parte superior */
        }
        ...
        /* Estilo para ajustar el espacio del footer cuando el formulario es largo */
        body {
            margin-bottom: 120px;
        }
    ...
    /* Agrega separación a los lados del formulario */
    .form-container {
        padding: 15px;
        margin: 10px;
    }

    /* Agrega separación pequeña de arriba y abajo */
    .form-group {
        margin-bottom: 10px;
        margin-top: 10px;
    }
            ...
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        ...
                        <a href="solicitud.php" class="dropdown-item active">Realizar cotización</a>
    ...
    <div class="container-fluid bg-primary py-4 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class=" text-white animated zoomIn">Cotización</h1>
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="form-container animate-fade-in">
                    <h2 class="mt-5 form-title text-center">Por favor, ingrese los datos del pedido</h2>
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="d-grid gap-2 d-grid-gap">
                            <button type="submit" class="btn btn-success">Realizar pedido</button>
                            <button type="button" class="btn btn-danger" onclick="limpiarCampos(), redireccionar()">Salir</button>
                        </div>
                    </form>
                </div>
            </div>
      ...
      <script>
        ...
        toggleSwitch.addEventListener('change', () => {
          if (toggleSwitch.checked) {
            ...
            window.location.href = 'LBC SUPPLIERS (Integradora) -INGLES-/solicitud.php';
          } else {
