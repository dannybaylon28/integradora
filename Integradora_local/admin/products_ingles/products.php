  ...
  background-color: black;
    ...
    <script>
        $(document).ready(function() {
            ...
            // OCULTAR EL MENSAHE DE ERROR DESPUES DE 10SEG
            setTimeout(function() {
                $(".alert").slideUp();
            }, 10000);
        });
...
<div class="container-fluid position-relative p-0" >
        ...
        <a href="" class="navbar-brand p-0">
            <br>
            <h1 class="m-0">Productos en inglés</h1>
            <br>
        </a>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class=" clearfix text-center">
                        ...
                        <a href="create_products.php" class="btn btn-add-product pull-right"><i class="fa fa-plus col-3"></i> Add product</a>   
                    </div>
                    ...
                    if ($result = $mysqli->query($sql)) {
                        if ($result->num_rows > 0) {
                            ...
                            while ($row = $result->fetch_array()) {
                                ...
                                echo "<td>" . $row['URL_images'] . "</td>";
                                echo "<td>";
                                echo '<a href="update_products.php?id=' . $row['idProducts'] . '" class="mr-3 text-primary" title="Update Record" data-toggle="tooltip"><span class="bi bi-pencil-square"></span></a>';
                                echo '<a href="delete_products.php?id=' . $row['idProducts'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                echo "</td>";
                                echo "</tr>";
                            }
                            echo "</tbody>";
