...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($input_car)) {
        $caracteristicas_err = "Please enter the characteristics.";
    } else {
        ...
        if ($stmt = $mysqli->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                if ($result->num_rows == 1) {
                    ...
                    $caracteristicas = $row["Attributes"];
                    $imagen = $row["URL_images"];
                } else {
                    // REDIRECCION A ERROR
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <img src="../../<?php echo $imagen; ?>" width="200" alt="Current Image">
                        </div>
                        <div class="form-group">
