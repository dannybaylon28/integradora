       ...
       <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu m-0">
                        <a href="productos.php" class="dropdown-item active">Catálogo</a>
    ...
    <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
        <div class="row py-5">
            <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                <h1 class="display-4 text-white animated zoomIn">Catálogo de productos</h1>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-17">
                <div class="row g-5">
                    ...
                    $sql = "CALL ObtenerProductosPaginados(?, ?)";
                                    ...
                                    <div class="blog-item bg-light rounded overflow-hidden">
                                        <div class="blog-img position-relative overflow-hidden">
                                            <div class="image-container">
                                              <img class="img-fluid custom-img-size" src="<?php echo $row['URL_imagen'] ?>" alt="">
                                            </div>
                                        </div>
                                        <div class="p-4">
                                            <h4 class="mb-3"><?php echo $row['Nombre_producto'] ?></h4>
                                            <p><?php echo shortenText($row['Descripcion'], 150); ?></p>
                                            <a class="text-uppercase" href="leermas.php?id=<?php echo $row['IdProductos']; ?>">Leer más <i class="bi bi-arrow-right"></i></a>
                                        </div>
                                    </div>
                                </div>
                                <?php
...
<div class="btn-center wow fadeInUp" data-wow-delay="0.2s">
    <div class="btn-container">
        <a href="solicitud.php" class="btn btn-primary btn-lg btn-animate">REALIZAR COTIZACIÓN AHORA</a>
    </div>
</div>
    </div>
</div>
      ...
      <script>
        ...
        toggleSwitch.addEventListener('change', () => {
          if (toggleSwitch.checked) {
            ...
            window.location.href = 'LBC SUPPLIERS (Integradora) -INGLES-/productos.php';
          } else {
